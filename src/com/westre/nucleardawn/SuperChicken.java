...
public class SuperChicken extends EntityChicken {
	private float targetSpeed;

	@SuppressWarnings("rawtypes")
	public SuperChicken(World world) {
		super(world);
        ...
        this.goalSelector.a(2, new PathfinderGoalAvoidPlayer(this, EntityOcelot.class, 6.0F, 0.25F, 0.3F));
        this.goalSelector.a(3, new PathfinderGoalMeleeAttack(this, EntityHuman.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(4, new PathfinderGoalMeleeAttack(this, EntityVillager.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(5, new PathfinderGoalMeleeAttack(this, EntityPig.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(6, new PathfinderGoalMeleeAttack(this, EntityCow.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(7, new PathfinderGoalMeleeAttack(this, EntitySheep.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(8, new PathfinderGoalMeleeAttack(this, EntityZombie.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(9, new PathfinderGoalMeleeAttack(this, SuperZombie.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(10, new PathfinderGoalMeleeAttack(this, EntitySkeleton.class, (float) this.bw * targetSpeed, true));
        this.goalSelector.a(11, new PathfinderGoalRandomStroll(this, 0.2F));
        this.goalSelector.a(12, new PathfinderGoalLookAtPlayer(this, EntityHuman.class, 8.0F));
        this.goalSelector.a(13, new PathfinderGoalRandomLookaround(this));
        this.goalSelector.a(14, new PathfinderGoalBreakDoor(this));
